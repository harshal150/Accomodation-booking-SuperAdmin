...
const ExpectedSettlementsList: FC = () => {
...
const handleExportToExcel = () => {
  ...
  XLSX.utils.book_append_sheet(workbook, worksheet, isDetailedView ? 'Detailed Data' : 'Invoices');
  XLSX.writeFile(workbook, isDetailedView ? 'Detailed_Data.xlsx' : 'Invoices.xlsx');
};
...
const handleExportToCSV = () => {
  ...
  link.setAttribute('download', isDetailedView ? 'Detailed_Data.csv' : 'Invoices.csv');
...
const handleShareReport = () => {
          ...
          <div id="kt_app_content" className="app-content flex-column-fluid" >
            ...
            >
               ...
               <div className="card-header align-items-center py-3 gap-2 gap-md-12">
                <h3 className="card-title">Expected Settlements</h3>
  ...
  <div className="row g-3">
    {/* Card 1: Total Paid from Last Settlements */}
    <div className="col-lg-4 col-md-6 col-sm-12">
      <div className="card h-100 " style={{ backgroundColor: '#d8f1ff', borderRadius: '8px', border:'1px dotted #336699'  }}>
        <div className="card-body text-center">
          ...
          <p className="mb-0" style={{ color: '#666' }}>Total paid from last settlements</p>
        </div>
      </div>
    </div>
    ...
    <div className="col-lg-4 col-md-6 col-sm-12">
      <div className="card h-100 " style={{ backgroundColor: '#f5f8fa', borderRadius: '8px', border:'1px dotted #336699'  }}>
        <div className="card-body text-center">
          <h5 className="mb-1 fw-bold" style={{ color: '#224466' }}>
            ₹{filteredInvoices
              .filter(invoice => {
          ...
          <p className="mb-0" style={{ color: '#666' }}>Today's amount</p>
        </div>
      </div>
    </div>

    {/* Card 3: Total Future Settlements */}
    <div className="col-lg-4 col-md-6 col-sm-12">
      <div className="card h-100 " style={{ backgroundColor: '#eaf4fc', borderRadius: '8px', border:'1px dotted #336699'  }}>
        <div className="card-body text-center">
          ...
          <p className="mb-0" style={{ color: '#666' }}>Total future settlements</p>
        </div>
      </div>
    </div>
  </div>
...
export {ExpectedSettlementsList}
